...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .AGENTSelectSettingsTab)) { note in
...
extension Notification.Name {
    static let AGENTSelectSettingsTab = Notification.Name("AGENTSelectSettingsTab")
}
