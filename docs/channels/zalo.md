...
- Install via CLI: `AGENT plugins install @AGENT/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `AGENT plugins install ./extensions/zalo`
   - From npm (if published): `AGENT plugins install @AGENT/zalo`
...
- Approve via:
  - `AGENT pairing list zalo`
  - `AGENT pairing approve zalo <CODE>`
...
- Example: `AGENT message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `AGENT channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `AGENT logs --follow`
