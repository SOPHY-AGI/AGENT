...
- Install via CLI: `AGENT plugins install @AGENT/zalouser`
- Or from a source checkout: `AGENT plugins install ./extensions/zalouser`
...
Approve via:
- `AGENT pairing list zalouser`
- `AGENT pairing approve zalouser <code>`
...
- Re-login: `AGENT channels logout --channel zalouser && AGENT channels login --channel zalouser`
