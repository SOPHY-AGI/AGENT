...
The recommended way to deploy Moltbot to production servers is via **[AGENT-ansible](https://github.com/AGENT/AGENT-ansible)** — an automated installer with security-first architecture.
...
```bash
curl -fsSL https://raw.githubusercontent.com/AGENT/AGENT-ansible/main/install.sh | bash
```

> **📦 Full guide: [github.com/AGENT/AGENT-ansible](https://github.com/AGENT/AGENT-ansible)**
>
...
# 2. Clone repository
git clone https://github.com/AGENT/AGENT-ansible.git
cd AGENT-ansible
...
- [Security Architecture](https://github.com/AGENT/AGENT-ansible/blob/main/docs/security.md)
- [Technical Details](https://github.com/AGENT/AGENT-ansible/blob/main/docs/architecture.md)
- [Troubleshooting Guide](https://github.com/AGENT/AGENT-ansible/blob/main/docs/troubleshooting.md)

## Related

- [AGENT-ansible](https://github.com/AGENT/AGENT-ansible) — full deployment guide
