...
1. Click [Deploy Moltbot](https://northflank.com/stacks/deploy-AGENT) to open the template.  
...
9. Open the Control UI at `/AGENT`.
...
4) Click **Run setup**.
5) Open the Control UI at `https://<your-northflank-domain>/AGENT`
