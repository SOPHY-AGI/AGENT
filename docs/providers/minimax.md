...
Configure manually via `AGENT.json`:
...
- Use `AGENT models list` and `AGENT models set minimax/MiniMax-M2.1` to switch.
...
- Running `AGENT configure` and selecting **MiniMax M2.1**, or
