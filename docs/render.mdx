...
<a href="https://render.com/deploy?repo=https://github.com/SOPHY-AGI/AGENT" target="_blank" rel="noreferrer">Deploy to Render</a>
...
The web dashboard is available at `https://<your-service>.onrender.com/AGENT`.
