...
Install the Lobster CLI on the **same host** that runs the Moltbot Gateway (see the [Lobster repo](https://github.com/AGENT/lobster)), and ensure `lobster` is on `PATH`.
