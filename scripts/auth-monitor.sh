...
#
# Suggested cron: */30 * * * * /home/admin/AGENT/scripts/auth-monitor.sh
#
# Environment variables:
#   NOTIFY_PHONE - Phone number to send Moltbot notification (e.g., +1234567890)
#   NOTIFY_NTFY  - ntfy.sh topic for push notifications (e.g., AGENT-alerts)
...
if [ "$DIFF_MS" -lt 0 ]; then
    send_notification "Claude Code auth EXPIRED! Moltbot is down. Run: ssh l36 '~/AGENT/scripts/mobile-reauth.sh'" "urgent"
    exit 1
