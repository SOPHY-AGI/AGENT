...
export CLAWDBOT_STATE_DIR="/tmp/AGENT-test"
export CLAWDBOT_CONFIG_PATH="${CLAWDBOT_STATE_DIR}/AGENT.json"
...
pnpm AGENT reset --scope config+creds+sessions --yes --non-interactive
...
pnpm AGENT uninstall --state --yes --non-interactive
