...
FEED_URL=${2:-"https://raw.githubusercontent.com/SOPHY-AGI/AGENT/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/SOPHY-AGI/AGENT/releases/download/v${VERSION}/"}
