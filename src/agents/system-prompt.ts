...
function buildDocsSection(params: { docsPath?: string; isMinimal: boolean; readToolName: string }) {
  ...
  return [
    ...
    "Source: https://github.com/SOPHY-AGI/AGENT",
    "Community: https://discord.com/invite/clawd",
    "Find new skills: https://clawdhub.com",
    "For Moltbot behavior, commands, config, or architecture: consult local docs first.",
    "When diagnosing issues, run `AGENT status` yourself when possible; only ask the user if you lack access (e.g., sandboxed).",
    "",
  ];
}
...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "If unsure, ask the user to run `AGENT help` (or `AGENT gateway --help`) and paste the output.",
    "",
    ...skillsSection,
    ...memorySection,
