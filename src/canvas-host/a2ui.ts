...
export const A2UI_PATH = "/__AGENT__/a2ui";
export const CANVAS_HOST_PATH = "/__AGENT__/canvas";
export const CANVAS_WS_PATH = "/__AGENT/ws";
...
(() => {
  ...
  const handlerNames = ["AGENTCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.AGENTPostMessage = postToNode;
  globalThis.AGENTSendUserAction = sendUserAction;
