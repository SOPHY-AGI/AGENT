...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    process.env.CLAWDBOT_STATE_DIR = "/tmp/AGENT-cli-state";
    process.env.CLAWDBOT_CONFIG_PATH = "/tmp/AGENT-cli-state/AGENT.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        CLAWDBOT_STATE_DIR: "/tmp/AGENT-daemon-state",
        CLAWDBOT_CONFIG_PATH: "/tmp/AGENT-daemon-state/AGENT.json",
